...
require_once($ENV->dirs->phpRoot.$ENV->dirs->api.'FileManager.php');
...
if($type==='tmp') {
	// in that case we only need to save that file/image and return it's path so that it can be displays to be processed further
